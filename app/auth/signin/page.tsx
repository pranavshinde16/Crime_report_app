...
export default function SignIn() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // In this context, "credentials" refers to a custom authentication provider defined in our NextAuth configuration. 
            // This provider allows users to log in using their email and password.
